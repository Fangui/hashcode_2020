...
struct Photo
{
    ...
    Photo(int id1, int id2)
    {
        ...
        {
            std::cerr << "Warning, strange behaviour ? tags1 or tags2 not found \n";
            return;
        }
    ...
    static std::unordered_map<int, std::unordered_set<unsigned char>> photos_h;
    static std::unordered_map<int, std::unordered_set<unsigned char>> photos_v;
};

void parse_input(const std::string &inp, char c);
